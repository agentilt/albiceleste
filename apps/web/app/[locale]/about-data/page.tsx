...
const COPY = {
  es: {
    ...
    home: [
      "La última lista muestra a los convocados con su temporada en el club desde el 1 de julio anterior al horizonte: partidos jugados y goles más asistencias, o vallas invictas para arqueros y defensores. El 1 de julio arranca la temporada europea y la segunda mitad de las sudamericanas, así los minutos se comparan.",
  ...
  en: {
    ...
    home: [
      "The last list shows its players with their club season since the 1 July before the horizon: games played and goals plus assists, or clean sheets for keepers and defenders. 1 July starts the European season and the second half of the South American ones, so minutes compare.",
